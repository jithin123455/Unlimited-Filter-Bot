...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("FOR FREE FIRE MOD", url="https://t.me/bandu_project"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/bandu_project"),
                    InlineKeyboardButton("Support Group", url="https://t.me/bandu_project")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/kalyaniv2/43357")
                ],
                [
